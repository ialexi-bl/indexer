export default {
  ...
  // Help
  'We tried to guess your language automatically. Change it, if it is wrong. You can do it later using the "View" menu.': 'Nous avons essayé de déterminer la langue automatiquement. Changez-la, si elle n\'est pas correcte. Vous pourrez le faire plus tard dans le menu "Vue"',
  'about_article': `
<0>Cette application est créée pour les collaborateurs du projet Poznan. Utilisez les menus en dessus pour commencer.</0>
<1>Remarquez, que cette application est faite par un amateur et elle peut contenir des bugs.</1>
`.trim(),
  'help_article': `
<0>Aide</0>
<1>L'espace de travail</1>
<2>L'espace de travail a trois parties: les formes des données générales, de l'imformation du mari et de la femme. Si vous sauvegardez les données, le champ de l'année ne changera pas et le numéro du document augmentera par un. Utilisez <1><0></0></1><2></2><3><0></0></3><4></4><5><0></0></5> pour naviguer au champ suivant et <7><0></0></7><8></8><9><0></0></9><10></10><11><0></0></11> pour aller au champ précédent. Si vous bougez en avant en ayant le focus sur le bouton "Ajouter", les données seront ajouter dans le document automatiquement.</2>
...
<10>Comme remarqué plus tôt, vous pouvez utiliser <1><0></0></1><2></2><3><0></0></3><4></4><5><0></0></5> et <7><0></0></7><8></8><9><0></0></9><10></10><11><0></0></11> pour naviguer entre les champs en avant et en arrière réspectivement.</10>
<11>Utilisez <13><0></0></13> pour marquer, qu'une personne est morte où c'est possible.</11>
<12>Vous pouvez effacer le champ avec <1><0></0></1>.</12>
<13>Appuyez sur l'étiquette du champ ou tappez <1><0></0></1> pour marquer, que vous n'êtes pas sûr de son contenu.</13>
<14>Sauvegardez le tableau avec <1><0></0></1>.</14>
`.trim(),
  ...
  "Contains headers (Don't change to auto detect)": "Intitulé (ne changez pas pour déter\u00ADminer auto\u00ADma\u00ADtique\u00ADment)",
  'Drag to specify, in which order the columns are arranged in your file': "Faites glisser pour définir l'ordre, dans lequel les champs sont arrangés",
  'An error happened during import': "Une erreure s'est passée au cours de l'importation",
  'Document imported successfully': 'Le document a été importé avec succès',
  'If you continue, all unsaved changes will be lost. Do you want to save them?': 'Si vous continuez, tous les changements non enregistrés seront perdus. Est-ce que vous voulez les sauvegarder?',
  ...
  'An error happened while creating a file': "Une erreure s'est passée au cours de la création du fichier",
  
  'Drag to specify the order of the input fields.': "Faites glisser pour déterminer l'ordeur des champs.",
}
